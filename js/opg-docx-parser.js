...
async function parsePatientReportDocx(arrayBuffer) {
    // ── 1. Unzip ───────────────────────────────────────────────────────────────
    ...
    if (tables.length === 0) {
        throw new Error(
            'No patient tables were found in this DOCX.\n' +
            'No normal patient-report records were found in this DOCX. ' +
            'Expected patient tables containing File Number and Patient name.'
        );
    }
